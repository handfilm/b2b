...
export const ECOSYSTEM_PORTALS: EcosystemPortalNode[] = [
  ...
  },
  {
    ...
    latencyMs: 22,
    previewFallbackImg: 'https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=800&q=80',
  },
  {
    id: 'textiles-handsandhead',
    domain: 'textiles.handsandhead.com',
    url: 'https://textiles.handsandhead.com',
    name: 'textiles.handsandhead.com',
